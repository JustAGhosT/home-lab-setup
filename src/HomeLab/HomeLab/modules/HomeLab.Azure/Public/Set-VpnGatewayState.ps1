    ...
    try {
        ...
        if ($Action -eq "Disable") {
            if (Get-Command Write-ColorOutput -ErrorAction SilentlyContinue) {
                ...
                Write-Host "Disabling VPN Gateway '$GatewayName'..." -ForegroundColor Yellow
                Write-Host "This operation may take a few minutes to complete." -ForegroundColor Yellow
            }
            ...
            if ($LASTEXITCODE -ne 0) {
                if (Get-Command Write-ColorOutput -ErrorAction SilentlyContinue) {
                    ...
                    Write-Host "Failed to disable VPN Gateway." -ForegroundColor Red
                }
                return $false
            }
            ...
            if (Get-Command Write-ColorOutput -ErrorAction SilentlyContinue) {
                ...
                Write-Host "VPN Gateway disable operation initiated successfully." -ForegroundColor Green
                Write-Host "The gateway will stop billing for compute resources when fully stopped." -ForegroundColor Green
            }
            return $true
        }
        else {
            if (Get-Command Write-ColorOutput -ErrorAction SilentlyContinue) {
                ...
                Write-Host "Enabling VPN Gateway '$GatewayName'..." -ForegroundColor Yellow
                Write-Host "This operation may take 15-30 minutes to complete." -ForegroundColor Yellow
            }
            ...
            if ($LASTEXITCODE -ne 0) {
                if (Get-Command Write-ColorOutput -ErrorAction SilentlyContinue) {
                    ...
                    Write-Host "Failed to enable VPN Gateway." -ForegroundColor Red
                }
                return $false
            }
            ...
            if (Get-Command Write-ColorOutput -ErrorAction SilentlyContinue) {
                ...
                Write-Host "VPN Gateway enable operation initiated successfully." -ForegroundColor Green
                Write-Host "The gateway will start billing for compute resources when fully started." -ForegroundColor Green
            }
            return $true
        }
    }
